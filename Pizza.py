...
#------ page 2------
    ...
    def Login(sf):
        ...
        sf.scr.destroy()
        sf.scr=Tk()
        sf.scr.title("TO SHUSISHA'S PIZZA")
        sf.scr.geometry("1366x768")
        ...
        sf.rg=Button(sf.loginf2,text="New TO Shusisha's Pizza's",command=lambda:sf.Register(),fg="white",cursor="hand2",bg="#8c68c1",font=("cooper black",20),bd=6)
    ...
    def about(sf):
        sf.scr1=Tk()
        sf.L=Label(sf.scr1,text="NEW SHUSISHA'S PIZZA SHOP")
        sf.L.pack()
        sf.scr1.mainloop()
...
#--  page 3------
    ...
    def Register(sf):
        sf.scr.destroy()
        sf.scr=Tk()
        sf.scr.title("Shusisha's Pizza's")
        sf.scr.geometry("1366x768")
        #sf.scr.resizable(False, False)
...
#--  page 6------
    def menulist(sf,x):
        ...
        sf.c.create_image(430,250,image=sf.veg)
        ...
        sf.vegbut.place(x=370,y=350)

        sf.nonveg=PhotoImage(file="Non.png")
        sf.c.create_image(840,250,image=sf.nonveg)
        ...
        sf.nonvegbut.place(x=740,y=350)


        sf.menuf2.pack(fill=BOTH,expand=0)
        sf.scr.mainloop()
...
#--  page 14------
 ...
 #-----  database-------
    ...
    def logindatabase(sf):
        ...
        sf.cur=sf.con.cursor()
        try:
            sf.cur.execute("create table customer(username varchar(50) not null,password varchar(50) not null,first varchar(50) not null,last varchar(50) not null,email varchar(50),mob number(10) not null)")
        except:
            pass
    ...
    def orderpay(sf,x):
        ...
        messagebox.showinfo("Pay","Payment can be done at the time of receiving your ordered items."
                                  "\n\n \t\tThank you \n \t\tHAVE A BITE AND HAVE A JOY!")
